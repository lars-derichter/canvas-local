 ...
 * <body>` shape with the full body, because existing callers still read it
 * that way: the sync layer matches on '404', and the external-tools probe
...
module.exports = { canvasRequest, get, post, put, del, CanvasApiError };
