...
function htmlToMarkdown(html, options = {}) {
  ...
  // Text-node escaping, minus turndown's blanket backslash in front of an
  // underscore markdown reads literally anyway — see
  // escapeKeepingIntrawordUnderscores above. `escape` is a prototype method
  // turndown calls as `self.escape(...)`, so an own property here shadows it
  // for this instance, the recursive turndown.turndown() the alert rule makes
  // included.
