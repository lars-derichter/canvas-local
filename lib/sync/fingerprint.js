 ...
 * had touched. `canvas_id` is listed there only so that pull strips one written
 * into a file by hand; it is not a frontmatter key, and it lives in the sync
 * row this fingerprint is stored on.
 *
