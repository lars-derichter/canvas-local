 ...
 *
 * This is the one for anything the author writes — every markdown item under
 ...
 * @param {'page'|'assignment'|'discussion'|'quiz'|'external_url'|'external_tool'|'file'} canvasType
 ...
 *   go and get.
 * - **quiz / external_url / external_tool** — references, with no object behind
