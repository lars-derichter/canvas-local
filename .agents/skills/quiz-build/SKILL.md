...
6. **Write the companion file** `evaluations/<year>/<slug>/questions.md`: the
   approved question list with correct answers and points (colleague-facing: the
   readable source of truth for the zip), plus an import section titled in the
   course language ("Importing into Canvas"; a Dutch course would title it
