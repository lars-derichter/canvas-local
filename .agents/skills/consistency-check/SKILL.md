...
8. **Offer to apply mechanical fixes.** Only the mechanical categories qualify:
   ...
   corrections. Ask whether the author wants all, a selection by number, or none
   — default is none. When applying, make minimal-diff edits, then re-run the
   relevant check to confirm. Judgement findings (glossary, terminology,
